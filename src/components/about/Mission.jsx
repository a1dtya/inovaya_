      ...
      <a href="/category/uncategorized/" className="w-full group" aria-label="Learn more about our mission">
        <div className="relative size-full py-[50px] px-[50px] lg:px-[100px] flex flex-col items-center justify-center text-center rounded-3xl min-h-[669px] lg:min-h-[493px] overflow-hidden bg-gradient-to-b from-[#003399] to-[#55c1d9]">
          ...
          <div className="w-full h-full relative items-center flex justify-center">
            <p className="w-[80%] mx-auto items-center mission-text text-white font-[Roboto-thin]">
              Preserving water resources to make it accessible to all
            </p>

            {/* Right-Bottom Corner SVG */}
            <svg
              className="absolute right-0 bottom-[-110px] transition-all duration-300 ease-in-out group-hover:w-[263px] group-hover:h-[181]"
              width="300px"
              height="181"
              viewBox="0 0 663 181"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
                ...
                clipRule="evenodd"
              />
              <text x="33%" y="60%" fill="black" font-size="18" font-family="Nunito-thin" style={{fontSize:'40px'}}>• Our Mission
              </text>
            </svg>
          </div>
